// Türkiye İlleri ve İlçeleri Veri Seti
// 81 il ve tüm ilçeleri

export const turkeyCities = [
  { name: 'Adana', districts: ['Seyhan', 'Yüreğir', 'Çukurova', 'Sarıçam', 'Karaisalı', 'Pozantı', 'Karataş', 'Yumurtalık', 'Aladağ', 'Kozan', 'Feke', 'Saimbeyli', 'Tufanbeyli', 'İmamoğlu', 'Ceyhan'] },
  ...
  { name: 'Antalya', districts: ['Akseki', 'Alanya', 'Elmalı', 'Finike', 'Gazipaşa', 'Gündoğmuş', 'Kaş', 'Korkuteli', 'Kumluca', 'Manavgat', 'Serik', 'Demre', 'İbradı', 'Kemer', 'Aksu', 'Döşemealtı', 'Kepez', 'Konyaaltı', 'Muratpaşa'] },
  ...
  { name: 'Aydın', districts: ['Merkez', 'Bozdoğan', 'Çine', 'Germencik', 'Karacasu', 'Koçarlı', 'Kuşadası', 'Kuyucak', 'Nazilli', 'Söke', 'Sultanhisar', 'Yenipazar', 'Buharkent', 'İncirliova', 'Karpuzlu', 'Köşk', 'Didim'] },
  { name: 'Balıkesir', districts: ['Altıeylül', 'Ayvalık', 'Balya', 'Bandırma', 'Bigadiç', 'Burhaniye', 'Dursunbey', 'Edremit', 'Erdek', 'Gönen', 'Havran', 'İvrindi', 'Karesi', 'Kepsut', 'Manyas', 'Marmara', 'Savaştepe', 'Sındırgı', 'Susurluk'] },
  ...
  { name: 'Bursa', districts: ['Osmangazi', 'Nilüfer', 'Yıldırım', 'Mudanya', 'Gemlik', 'Orhangazi', 'İznik', 'Orhaneli', 'Keles', 'Büyükorhan', 'Harmancık', 'Gürsu', 'Kestel', 'Yenişehir', 'Karacabey', 'Mustafakemalpaşa', 'İnegöl'] },
  ...
  { name: 'Denizli', districts: ['Merkez', 'Acıpayam', 'Babadağ', 'Baklan', 'Bekilli', 'Beyağaç', 'Bozkurt', 'Buldan', 'Çal', 'Çameli', 'Çardak', 'Çivril', 'Güney', 'Honaz', 'Kale', 'Sarayköy', 'Serinhisar', 'Tavas', 'Pamukkale'] },
  ...
  { name: 'Erzurum', districts: ['Merkez', 'Aşkale', 'Çat', 'Hınıs', 'Horasan', 'İspir', 'Karayazı', 'Narman', 'Oltu', 'Olur', 'Pasinler', 'Şenkaya', 'Tekman', 'Tortum', 'Köprüköy', 'Pazaryolu', 'Aziziye', 'Palandöken', 'Yakutiye'] },
  { name: 'Eskişehir', districts: ['Odunpazarı', 'Tepebaşı', 'Alpu', 'Beylikova', 'Çifteler', 'Günyüzü', 'Han', 'İnönü', 'Mahmudiye', 'Mihalgazi', 'Mihalıççık', 'Sarıcakaya', 'Seyitgazi', 'Sivrihisar', 'Çukurhisar'] },
  { name: 'Gaziantep', districts: ['Şahinbey', 'Şehitkamil', 'Oğuzeli', 'Araban', 'İslahiye', 'Karkamış', 'Nizip', 'Nurdağı', 'Yavuzeli'] },
  { name: 'Giresun', districts: ['Merkez', 'Alucra', 'Bulancak', 'Çanakçı', 'Dereli', 'Doğankent', 'Espiye', 'Eynesil', 'Görele', 'Güce', 'Keşap', 'Piraziz', 'Şebinkarahisar', 'Tirebolu', 'Yağlıdere'] },
  { name: 'Gümüşhane', districts: ['Merkez', 'Kelkit', 'Köse', 'Kürtün', 'Şiran', 'Torul'] },
  { name: 'Hakkari', districts: ['Merkez', 'Çukurca', 'Şemdinli', 'Yüksekova'] },
  { name: 'Hatay', districts: ['Antakya', 'Altınözü', 'Belen', 'Dörtyol', 'Erzin', 'Hassa', 'İskenderun', 'Kırıkhan', 'Kumlu', 'Reyhanlı', 'Samandağ', 'Yayladağı', 'Arsuz', 'Defne', 'Payas'] },
  ...
  { name: 'İstanbul', districts: ['Adalar', 'Bakırköy', 'Beşiktaş', 'Beykoz', 'Beyoğlu', 'Çatalca', 'Eyüpsultan', 'Fatih', 'Gaziosmanpaşa', 'Kadıköy', 'Kartal', 'Sarıyer', 'Silivri', 'Şile', 'Şişli', 'Üsküdar', 'Zeytinburnu', 'Büyükçekmece', 'Kağıthane', 'Küçükçekmece', 'Pendik', 'Ümraniye', 'Bayrampaşa', 'Avcılar', 'Bağcılar', 'Bahçelievler', 'Güngören', 'Maltepe', 'Sultanbeyli', 'Tuzla', 'Esenler', 'Arnavutköy', 'Ataşehir', 'Başakşehir', 'Beylikdüzü', 'Çekmeköy', 'Esenyurt', 'Sancaktepe', 'Sultangazi'] },
  { name: 'İzmir', districts: ['Aliağa', 'Bayındır', 'Bergama', 'Bornova', 'Çeşme', 'Dikili', 'Foça', 'Karaburun', 'Karşıyaka', 'Kemalpaşa', 'Kınık', 'Kiraz', 'Menemen', 'Ödemiş', 'Seferihisar', 'Selçuk', 'Tire', 'Torbalı', 'Urla', 'Beydağ', 'Buca', 'Konak', 'Menderes', 'Balçova', 'Çiğli', 'Gaziemir', 'Narlıdere', 'Güzelbahçe', 'Bayraklı', 'Karabağlar'] },
  { name: 'Kahramanmaraş', districts: ['Afşin', 'Andırın', 'Çağlayancerit', 'Ekinözü', 'Elbistan', 'Göksun', 'Nurhak', 'Pazarcık', 'Türkoğlu', 'Dulkadiroğlu', 'Onikişubat'] },
  ...
  { name: 'Kocaeli', districts: ['Gebze', 'Gölcük', 'Kandıra', 'Karamürsel', 'Körfez', 'Derince', 'Başiskele', 'Çayırova', 'Darıca', 'Dilovası', 'İzmit', 'Kartepe'] },
  { name: 'Konya', districts: ['Merkez', 'Akören', 'Akşehir', 'Altınekin', 'Beyşehir', 'Bozkır', 'Cihanbeyli', 'Çeltik', 'Çumra', 'Derbent', 'Derebucak', 'Doğanhisar', 'Emirgazi', 'Ereğli', 'Güneysinir', 'Hadim', 'Halkapınar', 'Hüyük', 'Ilgın', 'Kadınhanı', 'Karapınar', 'Kulu', 'Sarayönü', 'Seydişehir', 'Taşkent', 'Tuzlukçu', 'Yalıhüyük', 'Yunak', 'Selçuklu', 'Karatay', 'Meram'] },
  ...
  { name: 'Manisa', districts: ['Ahmetli', 'Akhisar', 'Alaşehir', 'Demirci', 'Gölmarmara', 'Gördes', 'Kırkağaç', 'Köprübaşı', 'Salihli', 'Sarıgöl', 'Saruhanlı', 'Selendi', 'Soma', 'Turgutlu', 'Şehzadeler', 'Yunusemre'] },
  ...
  { name: 'Muğla', districts: ['Bodrum', 'Dalaman', 'Datça', 'Fethiye', 'Kavaklıdere', 'Köyceğiz', 'Marmaris', 'Milas', 'Ortaca', 'Ula', 'Yatağan', 'Menteşe', 'Seydikemer'] },
  ...
  { name: 'Trabzon', districts: ['Akçaabat', 'Araklı', 'Arsin', 'Beşikdüzü', 'Çarşıbaşı', 'Çaykara', 'Dernekpazarı', 'Düzköy', 'Hayrat', 'Köprübaşı', 'Maçka', 'Of', 'Şalpazarı', 'Sürmene', 'Tonya', 'Vakfıkebir', 'Yomra', 'Ortahisar'] },
...
// İl isimlerini alfabetik sıraya göre döndür (Türkçe karakterler için doğru sıralama)
// Türkçe karakterleri ASCII karakterlere dönüştürerek sıralama yapıyoruz
export const getCityNames = () => {
  const cityNames = turkeyCities.map(city => city.name);
  ...
  return cityNames.sort((a, b) => {
    ...
    const asciiA = toAscii(a);
    const asciiB = toAscii(b);
    
    // ASCII karakterlere dönüştürülmüş haliyle karşılaştır
    if (asciiA < asciiB) return -1;
    if (asciiA > asciiB) return 1;
    
    // ASCII hali aynıysa, orijinal haliyle Türkçe locale ile karşılaştır
    // Bu durumda İ (noktalı) I (noktasız)'dan önce gelir
    return a.localeCompare(b, 'tr', { sensitivity: 'base' });
  });
};

// Belirli bir ilin ilçelerini döndür (Türkçe karakterler için locale-aware)
export const getDistrictsByCity = (cityName) => {
  const city = turkeyCities.find(c => c.name === cityName);
  if (!city) return [];
  // Türkçe karakterleri doğru sıralamak için locale-aware sıralama
  return city.districts.sort((a, b) => {
    return a.localeCompare(b, 'tr', { sensitivity: 'base' });
  });
};

// Tüm ilçeleri döndür (filtreleme için - Türkçe karakterler için locale-aware)
